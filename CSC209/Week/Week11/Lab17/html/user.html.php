    ...
    <body>
        ...
        <?php
            ...
            if($imagesNr != 0){
                ...
                echo '<div id="image-warning" class="error-message-box"> <button class="close-button" type="button" onclick="removeImageWarning()">&#10006</button> <p class="error-message">NOTE: You have no images, please upload an image file to view images.</p></div>';
            }
        ?>
        <script>
            if (document.getElementsByClassName("slideshow-container")[0]){
