...
{   
    ...
    //"sets" the red squares position to start at 0 which is the left corner, just variable keeping track of position not actual position of div element 
    var redPos = 0;
    ...
    function stepRed() {
        if (redPos == 350) {
            ...
            //increase the pixel by one from the top position and left position
            redPos++; 
